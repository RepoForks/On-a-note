...
import bov.vitali.onanote.Utils;
...
public class EditTaskDialogFragment extends DialogFragment {
    ...
    public static EditTaskDialogFragment newInstanse (ModelTask task) {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        alertDalog.setOnShowListener(new DialogInterface.OnShowListener() {
            @Override

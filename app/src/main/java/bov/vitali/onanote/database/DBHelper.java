...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String SELECTOIN_TIME_STAMP = TASK_TIME_STAMP_COLUMN + " = ?";
    public static final String SELECTOIN_LIKE_TITLE = TASK_TITLE_COLUMN + " LIKE ?";
    ...
    public void removeTask(long timeStamp) {
        getWritableDatabase().delete(TASKS_TABLE, SELECTOIN_TIME_STAMP, new String[] {Long.toString(timeStamp)});
    }
